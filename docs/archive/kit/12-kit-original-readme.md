...
# 12 · README original del kit base (archivado)

> Documento histórico: es el README del **WhatsApp AI Agent Kit** sobre el que
> se construyó este proyecto. Se conserva porque describe piezas que seguimos
> usando (Baileys, SQLite, dashboard, watchdog) y el despliegue en VPS.
> **El agente de IA que describe está DESACTIVADO** en este proyecto: requiere
> doble opt-in (`OPENROUTER_API_KEY` + `AI_AGENT_ENABLED=1`).
> La documentación vigente es [PEDRO-MVP.md](../PEDRO-MVP.md).
