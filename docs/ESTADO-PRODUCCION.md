...
> (esquema 29)**, que contiene íntegro el candidato de abajo (`v4.2` @
...
> El salto de esquema desde producción (15) es **15 → 29** (22 = validacion de direcciones, 23 = auto-despacho, 24 = canal de despacho, 25 = auto-cancelacion IA, 26 = aviso de despacho, 27 = tope diario de IA, 28 = estado de corrida de discovery, 29 = cola de busquedas; 07-09), todo aditivo y
