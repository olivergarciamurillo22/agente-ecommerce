...
> (esquema 23)**, que contiene íntegro el candidato de abajo (`v4.2` @
...
> El salto de esquema desde producción (15) es **15 → 23** (22 = validación de direcciones, 23 = auto-despacho; 07-09), todo aditivo y
