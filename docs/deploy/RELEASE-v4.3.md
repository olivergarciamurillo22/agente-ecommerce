...
- SQLite `integrity_check=ok`, `user_version=22` (19 = Hunter, 20 = predictivo, 21 = discovery, 22 = validación de direcciones; el doc decía 19 antes de la consolidación del 07-09) y recuentos de pedidos, conversaciones, mensajes, outbox y eventos coherentes con los anotados antes del despliegue;
