...
> **07-09-2026 (noche) — la rama canónica es `release/casamable-v4.3` (esquema 30). DESPLEGADA en el NAS esa misma noche (`22f8013`, esquema 17 → 30); el 08-09 se desplegaron los fixes de seguridad de la auditoría: producción corre `f2af494` (esquema 30). Informe: `docs/deploy/DEPLOY-REPORT-v4.3-2026-09-07.md`.**
