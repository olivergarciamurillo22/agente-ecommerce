...
export const ENV_SCHEMA: EnvVarSpec[] = [
  ...
  // ── SAFETY (los interruptores que impiden acciones reales) ──
  {
    ...
    category: "SAFETY",
    secret: false,
    description: "1 = solo se escribe a la allowlist. OBLIGATORIO en todos los pilotos y en local.",
    requiredFor: [],
  ...
  },
  {
    ...
    category: "SAFETY",
    secret: false,
    description: "1 = freno de emergencia global. Debe estar en 0 salvo incidente.",
    requiredFor: [],
    defaultValue: "0",
    validate: bool01,
  },
